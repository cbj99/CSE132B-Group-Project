		...
		<tr>
			...
			<td>
				...
				if(action != null && action.equals("insert")){
					...
					insertEnrollment.setString(5, request.getParameter("GRADE"));
				...
				if(action != null && action.equals("update")){
					conn.setAutoCommit(false); 
					PreparedStatement updateEnrollment = conn.prepareStatement("UPDATE past_enrollment SET grade=? WHERE student_id=? and course_number=? and year_=? and quarter=?;"); 
				...
				if(action != null && action.equals("delete")){
					conn.setAutoCommit(false); 
					PreparedStatement deldeteEnrollment = conn.prepareStatement("DELETE FROM past_enrollment WHERE student_id=? and course_number=? and year_=? and quarter=?;");
