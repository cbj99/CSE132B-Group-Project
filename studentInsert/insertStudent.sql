...
INSERT INTO BSMSStudent VALUES 
    (2, 2, 'CA_resident', 'enrolled', 'fist_1', 'last_1', 'middle_2', 'computer science department'); 

INSERT INTO MSStudent VALUES 
    (3, 3, 'CA_resident', 'enrolled', 'fist_1', 'last_1', 'middle_2', 'computer science department'); 
...
UPDATE student SET SSN = 100, identity_='non_CA_resident', enrollment_status='graduated', first_name='first_1_modified', last_name = 'last_1_modified', middle_name='middle_1_modified' where student_id=1;
